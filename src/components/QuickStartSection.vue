            ...
            <div class="row">
                <div class="col bg-dark p-4 rounded mb-4">
                    ...
                    <div>
                        ...
                        <span class="text-secondary me-3">npm install</span>
                        <span class="text-success me-1">-g</span>
                        <span class="text-secondary">claps.js</span>
                    </div>
                </div>
                <div class="d-flex align-items-center px-0">
                    <i class="fas fa-check me-2"></i><span class="footer-text text-secondary me-5">Organize your data</span>
                    <i class="fas fa-check me-2"></i><span class="footer-text text-secondary">Work with any team</span>
                </div>
            </div>
            <!-- /HOW TO INSTALL -->
        </div>
